...
class Article {
  ...
  public Article(String ititle, String ibody, String iconc) {
    this.title = ititle;
    this.body = ibody;
    this.conclusion = iconc;

    refs = new ArrayList<>();
  }
  public void addBookToReferences(Book book) { refs.add(book); }

  private void printReference(Book book, int from, int to) {
    String ref = book.createReference(from, to, this.title);
  }
